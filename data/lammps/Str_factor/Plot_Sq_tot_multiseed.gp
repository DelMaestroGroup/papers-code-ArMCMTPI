...
set output 'Sq_tot_vs_q_symmNorm.tex'
...
#"New_Sq_exp_k4.0.txt" u 1:2 w lp ps 1.2 pt 9 lt 1 lw 3 lc rgb 'brown' ti '\scalebox{0.7}{Exp. $k_{i}=4.0$\AA$^{-1}$}'
#"New_Sq_exp_k2.5.txt" u 1:2 w lp ps 1.0 pt 5 lt 1 lw 3 lc rgb '#2984D1' ti '\scalebox{0.7}{Exp. $k_{i}=2.5$\AA$^{-1}$}'
#"New_Sq_exp_k1.71.txt" u 1:2 w lp ps 0.9 pt 7 lt 1 lw 3 lc rgb '#FE9A37' ti '\scalebox{0.7}{Exp. $k_{i}=1.71$\AA$^{-1}$}'

plot "Sq_exp_k1.71.txt" u 1:2 w lp ps 0.9 pt 7 lt 1 dt 3 lw 2 lc rgb '#FE9A37' ti '\scalebox{0.7}{Exp. $k_{i}=1.71$\AA$^{-1}$}',"Sq_exp_k2.5.txt" u 1:2 w lp ps 1.0 pt 5 lt 1 dt 3 lw 2 lc rgb '#2984D1' ti '\scalebox{0.7}{Exp. $k_{i}=2.5$\AA$^{-1}$}', "Sq_exp_k4.0.txt" u 1:2 w lp ps 1.2 pt 9 lt 1 dt 3 lw 2 lc rgb 'brown' ti '\scalebox{0.7}{Exp. $k_{i}=4.0$\AA$^{-1}$}',"Debye_Sq_vs_q_5seed_average_Rc_22.5.txt" u 1:2 w l lw 3 lt 1 lc rgb 'dark-green' ti '',"" u 1:2:3 w yerrorbars ps 0.4 pt 6 lw 2 lt 1 lc rgb 'dark-green' ti '\scalebox{0.7}{Ar-Ar + Ar-MCM}'

#"<paste debye_Sq_vs_q_seed1_symm_avgd.txt debye_Sq_vs_q_seed2_symm_avgd.txt debye_Sq_vs_q_seed3_symm_avgd.txt debye_Sq_vs_q_seed4_symm_avgd.txt debye_Sq_vs_q_seed5_symm_avgd.txt" u 1:(0.2*(($8)+($16)+($24)+($32)+($40))) w l lw 4 lt 1 lc rgb 'dark-green' ti '\scalebox{0.7}{Ar-Ar + Ar-MCM}'
